    ...
    return (
      <p id="errorBox" className="alert alert-danger centered">
        ...
        {!this.state.accountValid && (
          ...
          >
            Account with that email already exists. Choose a different email
            address or reset password.
            <br />
          </a>
        )}
        {!this.state.passwordValid && (
        ...
        {!this.state.repeatPasswordValid && (
          ...
          >
            Make sure repeated password matches original password
            <br />
          </a>
        )}
        {!this.state.securityQuestionValid && (
        ...
        <form onSubmit={this.handleSubmit} noValidate>
          ...
          <div className="mb-3 centered">
            ...
            <div id="passwordDescr" className="form-text">
              Password must be at least eight characters with at least one upper
          ...
          <div className="mb-3 centered">
            ...
            <div id="profilePicDescr" className="form-text">
              A profile picture that represents you in the app (defaults to a
              generic picture)
            </div>
          </div>
          <div className="mb-3 centered">
